...
4. A new page will open (Fig. \@ref(fig:primer)). Click on "Choose File" and upload the sequence that you saved during the "DNA Sequence Analysis" exercise. 

(ref:primer) Primer-BLAST sequence entry form.
